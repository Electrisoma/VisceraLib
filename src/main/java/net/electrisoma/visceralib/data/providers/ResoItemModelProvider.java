...
//public class ResoItemModelProvider extends ItemModelProvider {
//    public ResoItemModelProvider(PackOutput output, ExistingFileHelper exFileHelper) {
//        super(output, VisceraLib.MOD_ID, exFileHelper);
//    }
//
//    @Override
//    protected void registerModels() {
//        BuiltInRegistries.ITEM.entrySet().stream()
//                .filter(entry -> entry.getKey().location().getNamespace().equals(VisceraLib.MOD_ID))
//                .forEach(entry -> {
...
//        return VisceraLib.MOD_ID + " Item Models";
//    }
//}