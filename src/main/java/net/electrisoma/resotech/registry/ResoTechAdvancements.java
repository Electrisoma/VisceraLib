...
import net.electrisoma.resotech.api.registration.builders.AdvancementBuilder;
...
import static net.electrisoma.resotech.api.registration.builders.AdvancementBuilder.TaskType.*;
