...
import static net.electrisoma.resotech.registry.ResoTechTags.NameSpace.*;
...
public class ResoTechTags {
    public static void init() {
        ...
        ResoTech.LOGGER.info("Registering Tags for " + ResoTech.NAME);
    }

    public enum NameSpace {
        MOD(ResoTech.MOD_ID, false, true),
        COMMON("c")
