...
//module("visceralib-commands-api-v1")        // server/client sided command creation helper using brigadier
...
//module("visceralib-transitive-access)       // provides mass transitive ATs/AWs (similar to Fabric API)